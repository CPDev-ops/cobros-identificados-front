...
const CardPayError: FC<CardPayErrorProps> = ({ amount, dateTime, /* dni, */ paymentId, domain }) => {
    ...
    return (
        <div className={`rounded-xl p-6 w-full max-w-xs sm:max-w-sm mx-auto text-white bg-gradient-to-r ${gradient} space-y-5 text-center shadow-lg`}>
            ...
            <div className="flex flex-col items-center gap-1">
                <MdErrorOutline className="text-red-600 bg-white rounded-full text-5xl" />
                <h2 className="text-lg ">¡Error! El pago no pudo completarse</h2>
            </div>
            ...
            <p className="text-[10px] border-t border-t-gray-300 text-gray-300 pt-2">
                El pago no pudo ser procesado. Por favor, intentá nuevamente o contactá a soporte si el problema persiste.
            </p>
        </div>
    )
}

export default CardPayError
